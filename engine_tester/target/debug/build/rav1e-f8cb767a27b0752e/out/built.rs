...
#[allow(dead_code)]
pub static RUSTC: &str = "C:\\Users\\gavin\\.cargo\\bin\\rustc.exe";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "C:\\Users\\gavin\\.rustup\\toolchains\\stable-x86_64-pc-windows-msvc\\bin\\rustdoc.exe";
...
#[doc=r#"The output of `C:\Users\gavin\.cargo\bin\rustc.exe -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.89.0 (29483883e 2025-08-04)";
#[doc=r#"The output of `C:\Users\gavin\.rustup\toolchains\stable-x86_64-pc-windows-msvc\bin\rustdoc.exe -V`; empty string if `C:\Users\gavin\.rustup\toolchains\stable-x86_64-pc-windows-msvc\bin\rustdoc.exe -V` failed to execute"#]
#[allow(dead_code)]
